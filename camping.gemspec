...
@spec ||= Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency('cgi', '~> 0.5.1')
  s.add_runtime_dependency('base64')
  s.add_runtime_dependency('logger', '~> 1.7')
  s.add_runtime_dependency('rake', '~> 13.4.2')
  s.add_runtime_dependency('mab', '~> 0.0', '>=0.0.3')
  s.add_runtime_dependency('tilt', '~> 2.7.0',)
  s.add_runtime_dependency('rack', '~> 3.0', '>= 3.2.6')
  s.add_runtime_dependency('rack-session', '~> 2.0', '>=2.1.2')
  s.add_runtime_dependency('rackup', '~> 2.3.1')
  s.add_runtime_dependency('irb', '~> 1.18')
  s.add_runtime_dependency('kdl', '~> 1.0', '>=1.0.5')
  s.add_runtime_dependency('zeitwerk', '~> 2.8', '>=2.8.2')
  s.add_runtime_dependency('listen', '~> 3')
  s.add_runtime_dependency('dry-logger', '~> 1.2.2')
  s.add_runtime_dependency('dry-inflector', '~> 1.3', '>= 1.3.1')
  s.add_runtime_dependency('samovar', '~> 2.4.1')
